...
I_max = []
N = 1200 # Antall Personer

class Rektor:

    # Startverdier
    hjemme = 3 # Det er folk som har hjemme skole så vi fjerner dem fra regningen
    ...
    print("Dersom vi følger Rektor sine råd blir {} smittet".format(high))